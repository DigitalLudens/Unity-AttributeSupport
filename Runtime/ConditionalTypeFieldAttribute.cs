...
public class ConditionalTypeFieldAttribute : PropertyAttribute
{
    #region Fields
    ...
    public ConditionalTypeFieldAttribute(string comparedPropertyName, bool comparedValue, Type comparedType, DisablingType disablingType = DisablingType.DontDraw)
    {
